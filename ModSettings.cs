...
namespace PiPDisabler
{
    internal static class ModSettings
    {
        ...
        // --- 0. Global ---
            ...
            EnableMeshSurgery = plugin.Config.Bind("6. Magic", "EnableMeshSurgery", true,
                new ConfigDescription(
                    "Enable runtime mesh cutting to bore a hole through the scope housing.",
                    null,
                    new ConfigurationManagerAttributes { IsAdvanced = true }));
            MeshSurgeryToggleKey = plugin.Config.Bind("6. Magic", "MeshSurgeryToggleKey", KeyCode.None,
                new ConfigDescription(
                    "Toggle key for mesh surgery.",
                    null,
                    new ConfigurationManagerAttributes { IsAdvanced = true }));
            RestoreOnUnscope = plugin.Config.Bind("6. Magic", "RestoreOnUnscope", true,
                new ConfigDescription(
                    "Restore original meshes when leaving scope.",
                    null,
                    new ConfigurationManagerAttributes { IsAdvanced = true }));
            PlaneOffsetMeters = plugin.Config.Bind("6. Magic", "PlaneOffsetMeters", 0.001f,
                new ConfigDescription(
                    "Offset applied along plane normal (meters).",
                    null,
                    new ConfigurationManagerAttributes { IsAdvanced = true }));
            PlaneNormalAxis = plugin.Config.Bind("6. Magic", "PlaneNormalAxis", "-Y",
                new ConfigDescription(
            ...
            CutRadius = plugin.Config.Bind("6. Magic", "CutRadius", 0f,
                new ConfigDescription(
            ...
            ShowCutPlane = plugin.Config.Bind("6. Magic", "ShowCutPlane", false, new ConfigDescription("Show green/red semi-transparent circles at the near/far cut plane positions.\n" +
                "Use this to visualize the cut endpoints.", null, new ConfigurationManagerAttributes { IsAdvanced = true }));
            ShowCutVolume = plugin.Config.Bind("6. Magic", "ShowCutVolume", false, new ConfigDescription("Show a semi-transparent 3D tube representing the full cut volume.\n" +
            ...
            CutVolumeOpacity = plugin.Config.Bind("6. Magic", "CutVolumeOpacity", 0.49f,
                new ConfigDescription(
            ...
            CutMode = plugin.Config.Bind("6. Magic", "CutMode", "Cylinder",
                new ConfigDescription(
            ...
            CylinderRadius = plugin.Config.Bind("6. Magic", "CylinderRadius", 0.011f,
                new ConfigDescription(
            ...
            MidCylinderRadius = plugin.Config.Bind("6. Magic", "MidCylinderRadius", 0.013f,
                new ConfigDescription(
            ...
            MidCylinderPosition = plugin.Config.Bind("6. Magic", "MidCylinderPosition", 0.28f,
                new ConfigDescription(
            ...
            FarCylinderRadius = plugin.Config.Bind("6. Magic", "FarCylinderRadius", 0.12f,
                new ConfigDescription(
                    ...
                    new AcceptableValueRange<float>(0f, 0.2f) , new ConfigurationManagerAttributes { IsAdvanced = true }));
            Plane1OffsetMeters = plugin.Config.Bind("6. Magic", "Plane1OffsetMeters", 0f,
                new ConfigDescription(
            ...
            Plane2Position = plugin.Config.Bind("6. Magic", "Plane2Position", 0.1138498f,
                new ConfigDescription(
                    ...
                    new AcceptableValueRange<float>(0f, 1f) , new ConfigurationManagerAttributes { IsAdvanced = true }));
            Plane2Radius = plugin.Config.Bind("6. Magic", "Plane2Radius", 0.0186338f,
                new ConfigDescription(
                    "Radius (meters) at plane 2.",
                    new AcceptableValueRange<float>(0f, 0.2f) , new ConfigurationManagerAttributes { IsAdvanced = true }));
            Plane3Position = plugin.Config.Bind("6. Magic", "Plane3Position", 0.55f,
                new ConfigDescription(
                    "Normalized depth of plane 3 from near (0) to far (1).",
                    new AcceptableValueRange<float>(0f, 1f) , new ConfigurationManagerAttributes { IsAdvanced = true }));
            Plane3Radius = plugin.Config.Bind("6. Magic", "Plane3Radius", 0.2f,
                new ConfigDescription(
                    "Radius (meters) at plane 3.",
                    new AcceptableValueRange<float>(0f, 0.2f) , new ConfigurationManagerAttributes { IsAdvanced = true }));
            Plane4Position = plugin.Config.Bind("6. Magic", "Plane4Position", 1f,
                new ConfigDescription(
                    "Normalized depth of plane 4 from near (0) to far (1). Usually 1.",
                    new AcceptableValueRange<float>(0f, 1f) , new ConfigurationManagerAttributes { IsAdvanced = true }));
            Plane4Radius = plugin.Config.Bind("6. Magic", "Plane4Radius", 0.2f,
                new ConfigDescription(
                    "Radius (meters) at plane 4 (away from player).",
                    new AcceptableValueRange<float>(0f, 0.2f) , new ConfigurationManagerAttributes { IsAdvanced = true }));
            CutStartOffset = plugin.Config.Bind("6. Magic", "CutStartOffset", 0.04084507f,
                new ConfigDescription(
            ...
            CutLength = plugin.Config.Bind("6. Magic", "CutLength", 0.755493f,
                new ConfigDescription(
            ...
            NearPreserveDepth = plugin.Config.Bind("6. Magic", "NearPreserveDepth", 0.02549295f,
                new ConfigDescription(
            ...
            ShowReticle = plugin.Config.Bind("6. Magic", "ShowReticle", true, new ConfigDescription("Render the scope reticle texture as a glowing overlay where the lens was.\n" +
            ...
            ReticleBaseSize = plugin.Config.Bind("6. Magic", "ReticleBaseSize", 0.030f,
                new ConfigDescription(
                    ...
                    new AcceptableValueRange<float>(0f, 0.2f) , new ConfigurationManagerAttributes { IsAdvanced = true }));
            ExpandSearchToWeaponRoot = plugin.Config.Bind("6. Magic", "ExpandSearchToWeaponRoot", true, new ConfigDescription("Expand the mesh surgery search root all the way up to the Weapon_root node.\n" +
            ...
            DebugShowHousingMask = plugin.Config.Bind("6. Magic", "DebugShowHousingMask", false, new ConfigDescription("Render a red/yellow overlay wherever the scope housing stencil mask is\n" +
            ...
            StencilIncludeWeaponMeshes = plugin.Config.Bind("6. Magic", "StencilIncludeWeaponMeshes", true, new ConfigDescription("Include weapon body renderers (found under the 'weapon' transform) in the\n" +
